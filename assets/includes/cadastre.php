            ...
            <div class="col-sm-6">
                <div class="form">    
                    <h5 class="card-title">SOU REFUGIADO</h5>
                        ...
                        <label for="exampleInputEmail1">Qual o seu e-mail?</label>
        ...
        <div class="col-sm-6">
                <div class="form">    
                    <h5 class="card-title">SOU EMPRESA</h5>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Qual o seu e-mail?</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Seu email">                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Senha</label>
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Senha">
                </div>
